...
//ip_sym: Array to store the input expression.
//ip_ptr: Pointer to the current position in the input expression.
//op: Array to store the output expression.
//tmp: Temporary array used during processing.
void e_prime();
void e();
void t_prime();
void t();
